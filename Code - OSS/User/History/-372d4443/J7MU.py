...
from ui.widgets.forms.live_trade import LiveTradeDialog


class LiveInstrumentCard(QFrame):
...
""")
        ...
        self.live_btn = QPushButton("➕ New Live Trade")
        self.live_btn.clicked.connect(self.open_live_trade)
        self.backtest_btn = QPushButton("📈 Live Trades (90)")
...
"""
        ...
        self.menu_layout.addWidget(self.live_btn)
        self.menu_layout.addWidget(self.backtest_btn)
    ...
    def open_live_trade(self):
        self.dialog = LiveTradeDialog()
        self.dialog.exec()

...
class TradeForm(QWidget):
    def __init__(self):
        ...
        self.before_path = QLineEdit()
        self.before_path.setReadOnly(True)

        self.before_button = QPushButton("Browse...")
        self.before_button.clicked.connect(self.select_before_image)

        before_layout.addWidget(self.before_path)
        before_layout.addWidget(self.before_button)
        ...
        self.after_path = QLineEdit()
        self.after_path.setReadOnly(True)

        self.after_button = QPushButton("Browse...")
        self.after_button.clicked.connect(self.select_after_image)

        after_layout.addWidget(self.after_path)
        after_layout.addWidget(self.after_button)
        ...
        self.extra_path.setReadOnly(True)

        self.extra_button = QPushButton("Browse...")
        self.extra_button.clicked.connect(self.select_extra_image)

        extra_layout.addWidget(self.extra_path)
        extra_layout.addWidget(self.extra_button)
        ...
        layout.addWidget(attachments_box)


    def select_before_image(self):
        filename, _ = QFileDialog.getOpenFileName(
            self,
            "Select Before Trade Screenshot",
            "",
            "Images (*.png *.jpg *.jpeg *.bmp)"
        )

        if filename:
            self.before_path.setText(filename)
            
    def select_after_image(self):
        filename, _ = QFileDialog.getOpenFileName(
            self,
            "Select After Trade Screenshot",
            "",
            "Images (*.png *.jpg *.jpeg *.bmp)"
        )

        if filename:
            self.after_path.setText(filename)


    def select_extra_image(self):
        filename, _ = QFileDialog.getOpenFileName(
            self,
            "Select Extra Screenshot",
            "",
            "Images (*.png *.jpg *.jpeg *.bmp)"
        )

        if filename:
            self.extra_path.setText(filename)
